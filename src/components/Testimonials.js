...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      name: "سعاد الغالي",
      text:
        "إنه مدهش لقد استبدلت كل المستحصرات التجميلية تقريبا بهذا الكريم، لم أعد أحتاج تلك المستحضرات التجميلية لأغطي مشاكل بشرتي، بالتأكيد ستوفرون الكثير من المال يا فتيات.",
      animation: "fade-left",
